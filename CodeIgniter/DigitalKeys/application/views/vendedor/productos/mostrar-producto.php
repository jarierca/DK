...
<head>
	<meta charset="UTF-8">
	<title>Mostrar Producto -  DigitalKey</title>
...
<div class="cuerpo mt-5 white">
	<div class="mod container text-center mt-5">
		<div class="d-sm-flex align-items-center justify-content-center mb-4">
			<h1 class="h3 mb-0 text-gray-800">Mostrar Productos</h1>
		</div>

		<?php
		if ($producto > 0){
			$longitud = count($producto);
			echo '<table class="table table-bordered text-white" id="dataTable" width="100%" cellspacing="0">';
			echo "<TR>";
			printf("<TD>Id</TD><TD>Nombre</TD><TD>Descripcion</TD><TD>Genero</TD><TD>Tipo</TD><TD>Plataforma</TD><TD>Plataforma Publicacion</TD><TD>Precio</TD><TD>Foto</TD>");
			print "</TR>";

			for ($j = 0; $j < $longitud; $j++){
				printf('<TD>'.$producto[$j][0]["id"].'</TD><TD>'.$producto[$j][0]["nombre"].'</TD><TD>Muy larga'/*.$producto[$j][0]["descripcion"]*/.'</TD><TD>'.$producto[$j][0]["genero"].'</TD><TD>'.$producto[$j][0]["tipo"].'</TD><TD>'.$producto[$j][0]["plataforma"].'</TD><TD>'.$producto[$j][0]["plataformaPublicacion"].'</TD><TD>'. $producto[$j][0]["precio"].'</TD><TD><img src="'.$producto[$j][0]["foto"].'" border="0" class="img-fluid" style="width: 50rem;"></TD>');
				print "</TR>";
			}
			echo '</table>';
		}else{
