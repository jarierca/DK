...
<head>
    <meta charset="UTF-8">
    <title>Reseteo Pass -  DigitalKey</title>
	<meta name="viewport" content="width=device-width, initial-scale=1.0, maximum-scale=1.0, user-scalable=0">
	<meta name="description" content="digitalkeys.com - Resetear Contraseña">
	<meta name="keywords" content="digitalkeys, resetear contraseña, cambiar contraseña">
    ...
    <script type="text/javascript">
		function validacion(){
			valor = document.getElementById("emailReseteo").value;
			if(valor.length == 0){
...
<div id="msg-box">
    ...
    <div class="cuerpo espacidado">
        ...
        <div class="login espacidado">
			<form name="formularioLogin" class="user" method="post" action="<?php echo base_url() . "User/comprobarCodigo"; ?>">
				<div class="form-group">
					<input type="text" class="form-control-2 form-control-user" id="codigo" name="codigo" placeholder="Introduce el codigo que has recibido por email">
				</div>
				<input type="submit" class="btn btn-primary-2 btn-user btn-block" id="enviar" name="enviar" value="Comprobar Codigo">
			</form>
            <hr>
