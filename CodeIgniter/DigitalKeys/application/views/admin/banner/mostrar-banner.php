...
<div class="cuerpo mt-5 white">
	<div class="mod container text-center mt-5">
		...
		echo "<TR>";
		printf("<TD>Id</TD><TD>Promocion</TD><TD>Foto</TD><TD>Alt</TD><TD>Activado</TD><TD>Nombre Promoción</TD>");
		print "</TR>";

		for ($j = 0; $j < $longitud; $j++){
			printf('<TD>'.$producto[$j]["id"].'</TD><TD>'.$producto[$j]["promocion"].'</TD><TD><img src="'.$producto[$j]["foto"].'" border="0" class="img-fluid" style="width: 20rem;"></TD><TD>'.$producto[$j]["alt"].'</TD><TD>'.$producto[$j]["activado"].'</TD><TD>'.$producto[$j]["id_promocion"].'</TD>');
			print "</TR>";
		}
		echo '</table>';
		?>
