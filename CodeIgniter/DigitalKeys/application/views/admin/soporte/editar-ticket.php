...
<head>
	...
	<script type="text/javascript">
		function validarModificacion(){
			...
			valor = document.getElementById("asuntoSoporteMod").value;
			if(valor== ""){
				alert("Debes escribir un asunto");
				return false;
			}

			valor = document.getElementById("mensajeSoporteMod").value;
			if(valor== ""){
...
<div class="cuerpo mt-5 white">
	<div class="container espacidado">
		...
		<div class="row justify-content-center align-self-center">
			<div class="col-sm-9">
				<form class="form-horizontal" role="form" action="<?php echo base_url() . "Admin/modificarTicket"; ?>" method="POST">
					<fieldset>
						<div class="form-group">
							<label class="col-sm-2 control-label">Fecha</label>
							<div class='col-sm-10'>
								<div class="input-group">
									<input class="form-control" type="text" id="fechainput" placeholder="Fecha" name="fechaSoporteMod" required="" readonly value="<?php echo $this->cifrado->superdescifrar($ticket[0]['fecha']);?>">
								</div>
							</div>
						</div>
						...
						<div class="form-group">
							...
							<div class="col-sm-10">
								<div class='input-group'>
									<select class="form-control-2" id="estadoSoporteMod" name="estadoSoporteMod" >
										<option value="">Selecciona el Estado</option>
										<option <?php if($this->cifrado->superdescifrar($ticket[0]['estado']) == "En Proceso") echo 'selected'; ?> value="En Proceso">En Proceso</option>
										<option <?php if($this->cifrado->superdescifrar($ticket[0]['estado']) == "Invalidado") echo 'selected'; ?> value="Invalidado">Invalidado</option>
										<option <?php if($this->cifrado->superdescifrar($ticket[0]['estado']) == "Solucionado") echo 'selected'; ?> value="Solucionado">Solucionado</option>
									</select>
								</div>
							</div>
						</div>
						...
						<div class="form-group">
							...
							<div class="col-sm-10">
								<div class='input-group'>
									<input type="text" class="form-control" placeholder="Nick" required="" name="nickSoporteMod" readonly title="Nick" value="<?php echo $this->cifrado->superdescifrar($ticket[0]['nick_user']); ?>">
								</div>
							</div>
						</div>
						...
						<div class="form-group">
							...
							<div class="col-sm-10">
								<div class='input-group'>
									<input type="email" class="form-control" id="inputEmail3" placeholder="Email" name="emailSoporteMod" required="" title="Ejemplo@dominio.com" value="<?php echo $this->cifrado->superdescifrar($ticket[0]['email_user']); ?>">
								</div>
							</div>
						</div>
						...
						<div class="form-group">
							...
							<div class="col-sm-10">
								<div class='input-group'>
									<input type="text" class="form-control" placeholder="Asunto" name="asuntoSoporteMod" required="" value="<?php  echo $this->cifrado->superdescifrar($ticket[0]['asunto']); ?>">
								</div>
							</div>
						</div>
						...
						<div class="form-group">
							...
							<div class="col-sm-10">
								<textarea class="form-control" rows="3" placeholder="Escriba su problema o consulta" name="mensajeSoporteMod" required=""><?php echo $this->cifrado->superdescifrar($ticket[0]['mensaje']); ?></textarea>
							</div>
						</div>
						...
						<div class="form-group">
							...
							<div class="col-sm-10">
								<div class='input-group'>
									<textarea class="form-control" rows="3" placeholder="Escriba la solucion" name="solucionSoporteMod" required=""><?php echo $this->cifrado->superdescifrar($ticket[0]['solucion']); ?></textarea>
								</div>
							</div>
						</div>
						...
						<div class="form-group">
							<div class="col-sm-offset-2 col-sm-10">
								<button type="submit" class="btn btn-outline-light">Modificar Ticket</button>
							</div>
						</div>
					</fieldset>
				</form>
