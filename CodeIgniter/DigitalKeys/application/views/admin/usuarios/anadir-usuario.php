...
<head>
	<meta charset="UTF-8">
	<title>Añadir Usuario -  DigitalKey</title>
...
<div class="cuerpo mt-5">
	<div class="mod container text-center mt-5">
		<form name="formularioAñadir"class="user" method="post" action="<?php echo base_url() . "Admin/anadirUsuario"; ?>" onsubmit="return validarModificacion()" enctype="multipart/form-data" >
			<div class="d-sm-flex align-items-center justify-content-between mb-4">
				<h1 class="h3 mb-0 text-gray-800">Añadir Usuario</h1>
			</div>

			<div class="form-group">
				<input type="text" class="form-control-2 form-control-user" id="nick" name="nick" placeholder="Nick">
			</div>

			<div class="form-group">
				<input type="password" class="form-control-2 form-control-user" id="password" name="password" placeholder="Password">
			</div>
			...
			<div class="form-group">
				<input type="text" class="form-control-2 form-control-user" id="apellido1" name="apellido1" placeholder="Primer Apellido">
			</div>

			<div class="form-group">
				<input type="text" class="form-control-2 form-control-user" id="apellido2" name="apellido2" placeholder="Segundo Apellido">
			</div>
			...
			<div class="form-group">
				<input type="email" class="form-control-2 form-control-user" id="mail" name="mail" placeholder="Email">
			</div>
			<div class="d-sm-flex align-items-center justify-content-center mt-5 mb-4">
				<a class="btn-carrito verde-perfil btn-icon-split btn-sm">
					...
					<span class="text">
						<input type="submit" class="btn btn-user" id="enviar" name="enviar" value="Guardar Usuario">
					</span>
				</a>
			</div>
		</form>
