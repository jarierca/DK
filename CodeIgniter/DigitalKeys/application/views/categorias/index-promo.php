...
<head>
	...
	<meta name="keywords" content="digitalkeys, gaming, keys, cd, clave, clave pc, categorias, promociones">
    ...
    <div class="container espacidado">
		...
		//var_dump($productos);
 		foreach ($productos as $pro){
			...
			printf('<div class="cuadro col-5">');
			$nombreProducto = str_replace(" ","-",$pro->nombre);
			printf('<a class="text-white" href="'.base_url() . "Productos/promocion/".$nombreProducto.'"><img id="img-promo"class="img-scalable img-fluid"src="'.$pro->foto.'"width="500rem"/></a>');
			printf('<h6 class="w-100"><a class="text-white" href="'.base_url() . "Productos/promocion/".$nombreProducto.'">'.$pro->nombre.'</a></h6>');
			printf('</a></div>');
