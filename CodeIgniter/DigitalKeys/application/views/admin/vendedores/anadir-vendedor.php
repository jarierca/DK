...
<head>
	<meta charset="UTF-8">
	<title>Añadir Vendedor -  DigitalKey</title>
	...
	<script type="text/javascript">
		function validarModificacion(){
			...
			valor = document.getElementById("ventas").value;
			if(valor.length == 0){
				alert("Falta las ventas");
				return false;
			}

			valor = document.getElementById("ganancias").value;
			if(valor.length == 0){
				alert("Falta las ganancias");
				return false;
			}

			valor = document.getElementById("valoraciones").value;
			if(valor.length == 0){
				alert("Falta las valoraciones");
				return false;
			}
...
<div class="cuerpo mt-5">
	<div class="mod container text-center mt-5">
		<form name="formularioAñadir"class="user" method="post" action="<?php echo base_url() . "Admin/anadirVendedor"; ?>" onsubmit="return validarModificacion()" enctype="multipart/form-data" >
			<div class="d-sm-flex align-items-center justify-content-between mb-4">
				<h1 class="h3 mb-0 text-gray-800">Añadir Vendedores</h1>
			</div>
			...
			<div class="form-group">
				<input type="text" class="form-control-2 form-control-user" id="telefono" name="telefono" placeholder="Telefono">
			</div>

			<div class="form-group">
				<input type="email" class="form-control-2 form-control-user" id="mail" name="mail" placeholder="Mail">
			</div>
			...
			<div class="d-sm-flex align-items-center justify-content-center mt-5 mb-4">
				<a class="btn-carrito verde-perfil btn-icon-split btn-sm">
					...
					<span class="text">
						<input type="submit" class="btn btn-user" id="enviar" name="enviar" value="Guardar Vendedor">
					</span>
				</a>
			</div>
		</form>
