...
<head>
    <meta charset="UTF-8">
    <title><?php echo $plat;?> -  DigitalKey</title>
	<meta name="viewport" content="width=device-width, initial-scale=1.0, maximum-scale=1.0, user-scalable=0">
	<meta name="description" content="digitalkeys.com - <?php echo $plat;?>">
	<meta name="keywords" content="digitalkeys, gaming, keys, cd, clave, clave pc, categorias, <?php echo $plat;?>">
...
<div class="cuerpo">
    <div class="container espacidado">
        <div class="divisoria-2"><h3 class="titulo-h3"><?php echo $plat;?></h3><div class="linea-divisoria-4"></div></div>
		...
		//var_dump($stock);
 		...
 		if (empty($productos)){
			echo 'No hay resultado para esta busqueda';
		}
		echo '</div>';
		echo '</div>';
		?>
