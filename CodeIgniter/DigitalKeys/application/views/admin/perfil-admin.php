...
<div class="cuerpo mt-5">
    <div class="container text-center mt-5">
		...
		<div class="row justify-content-center align-self-center mt-4 mb-4">
			<a href="<?php echo base_url() . "Admin/modificarDatosVista"; ?>" class="btn-whitelist btn-icon-split btn-sm">
			...
			<a href="<?php echo base_url() . "Admin/modificarPassVista"; ?>" class="btn-whitelist btn-icon-split btn-sm">
			  <span class="icon text-white-50">
				<i class="fas fa-edit"></i>
			  </span>
