<?php 
    ...
    $correo->Subject = "Nuevo Ticket - Soporte";//asunto
    //Se pone el texo del mensaje
    $correo->MsgHTML("¡Hola! ".$nick.".<br>Gracias por ponerte en contacto con el soporte de Digital Keys, nuestro equipo intentara solicionar tu problema lo mas rapido posible.<br> Tambien puedes ver el estado y toda la informacion del Ticket en el apartado de Soporte.");//mensaje o cupor del correo
