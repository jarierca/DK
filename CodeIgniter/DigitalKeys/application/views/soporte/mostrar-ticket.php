...
<head>
	...
	<meta name="description" content="digitalkeys.com - Mostrar Información del Ticket">
	<meta name="keywords" content="digitalkeys, ticket, soporte, ver ticket, iformacion ticket">
						...
						foreach ($ticket as $tick){
							...
							echo '<div class="panel panel-success tablas-soporte-opciones">
									  <div class="panel-heading text-center subtabla-soporte-opciones">
									 	 <h5>Ticket &nbsp;#'.$this->cifrado->superdescifrar($tick['serie']).'<a href="'.base_url() . "User/borrarTicket/".$tick['id'].'" class="btn text-white float-right"><i class="fa fa-trash" aria-hidden="true"></i></a></h5>
									  </div>
											  ...
											  <div class="col-sm-12">
												  <div class="row">
													  <div class="col-sm-8">
															...
															<br>
															<div class="row">
																  <div class="col-sm-12"><strong>Solución:</strong> '.$this->cifrado->superdescifrar($tick['solucion']).'</div>
															</div>
													 </div>
												 </div>
											</div>
