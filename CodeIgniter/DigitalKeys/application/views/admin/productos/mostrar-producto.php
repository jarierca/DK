...
<div class="cuerpo mt-5 white">
	<div class="mod container text-center mt-5">
		...
		echo "<TR>";
		printf("<TD>Id</TD><TD>Nombre</TD><TD>Descripcion</TD><TD>Genero</TD><TD>Tipo</TD><TD>Plataforma</TD><TD>Plataforma Publicacion</TD><TD>Precio</TD><TD>Foto</TD><TD>Fecha Lanzamiento</TD>");
		print "</TR>";

		for ($j = 0; $j < $longitud; $j++){
			printf('<TD>'.$producto[$j]["id"].'</TD><TD>'.$producto[$j]["nombre"].'</TD><TD>Muy larga'/*.$producto[$j]["descripcion"]*/.'</TD><TD>'.$producto[$j]["genero"].'</TD><TD>'.$producto[$j]["tipo"].'</TD><TD>'.$producto[$j]["plataforma"].'</TD><TD>'.$producto[$j]["plataformaPublicacion"].'</TD><TD>'. $producto[$j]["precio"].'</TD><TD><img src="'.$producto[$j]["foto"].'" border="0" class="img-fluid" style="width: 50rem;"></TD><TD>'. $producto[$j]["fecha"].' </TD>');
			print "</TR>";
		}
		echo '</table>';
		?>
