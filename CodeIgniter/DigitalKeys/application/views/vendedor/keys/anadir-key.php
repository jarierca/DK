...
<head>
	<meta charset="UTF-8">
	<title>Añadir Key -  DigitalKey</title>
	...
	<script type="text/javascript">
		function validarModificacion(){
			...
			if(valor.length == 0){
				alert("Falta el valor");
				return false;
			}

			valor = document.getElementById("idproducto").value;
			if(valor.length == 0){
				alert("Faltan el idproducto");
				return false;
			}

			valor = document.getElementById("idvendedor").value;
			if(valor.length == 0){
	...
	<nav class="navbar navbar-expand  topbar mb-2">
		<div class="barra-principal">
			<div class=" row mx-auto">
				...
				<a class="navbar-brand" href="<?php echo base_url() . "Vendedor/inicio"; ?>#page-top"><img class="img-logo" src="<?php echo base_url()."assets/"; ?>img/logo2.png" alt="Logo de la empresa" title="Logo"/></a>
	...
	<div class="modal-dialog" role="document">
		<div class="modal-content bg-morado">
			...
			<div class="modal-footer">
				...
				<a class="btn btn-cerrar-sesion" href="<?php echo base_url() . "Vendedor/cerrarSesion"; ?>">Cerrar Sesión</a>
			</div>
		</div>
	</div>
</div>
<div class="cuerpo mt-5">
	<div class="mod container text-center mt-5">
		<form name="formularioAñadir"class="user" method="post" action="<?php echo base_url() . "Vendedor/anadirKey"; ?>" onsubmit="return validarModificacion()" enctype="multipart/form-data" >
			<div class="d-sm-flex align-items-center justify-content-center mb-4">
				<h1 class="h3 mb-0 text-gray-800">Añadir Key</h1>
			</div>

			<div class="form-group">
				<input type="text" class="form-control-2 form-control-user" id="valor" name="valor" placeholder="Valor">
			</div>

			<div class="form-group">
				<input type="text" class="form-control-2 form-control-user" id="idvendedor" name="idvendedor" placeholder="idVendedor">
			</div>

			<div class="form-group">
				<input type="text" class="form-control-2 form-control-user" id="idproducto" name="idproducto" placeholder="idproducto" value="<?php echo $productoSel;?>" readonly>
			</div>
			...
			<div class="d-sm-flex align-items-center justify-content-center mt-5 mb-4">
				<a class="btn-carrito verde-perfil btn-icon-split btn-sm">
					...
					<span class="text">
						<input type="submit" class="btn btn-user" id="enviar" name="enviar" value="Guardar Key">
					</span>
				</a>
			</div>
		</form>
