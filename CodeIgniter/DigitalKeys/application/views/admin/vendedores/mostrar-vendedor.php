...
<head>
	<meta charset="UTF-8">
	<title>Mostrar Vendedores -  DigitalKey</title>
...
<div class="cuerpo mt-5 white">
	<div class="mod container text-center mt-5">
		<div class="d-sm-flex align-items-center justify-content-center mb-4">
			<h1 class="h3 mb-0 text-gray-800">Mostrar Vendedores</h1>
		</div>
		...
		echo "<TR>";
		printf("<TD>Id</TD><TD>Nombre</TD><TD>Mail</TD><TD>Telefono</TD>");
		print "</TR>";

		for ($j = 0; $j < $longitud; $j++){
			printf('<TD>'.$vendedor[$j]["id"].'</TD><TD>'.$this->cifrado->superdescifrar($vendedor[$j]["nombre"]).'</TD><TD>'.$this->cifrado->superdescifrar($vendedor[$j]["mail"]).'</TD><TD>'.$this->cifrado->superdescifrar($vendedor[$j]["telefono"]).'</TD>');
			print "</TR>";
		}
		echo '</table>';
		?>
