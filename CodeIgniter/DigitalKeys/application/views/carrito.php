...
<head>
    <meta charset="UTF-8">
    <title>Carrito -  DigitalKey</title>
	<meta name="viewport" content="width=device-width, initial-scale=1.0, maximum-scale=1.0, user-scalable=0">
	<meta name="description" content="digitalkeys.com - Tu Carrito">
	<meta name="keywords" content="digitalkeys, carrito">
...
<div class="cuerpo">
	<div class="container espacidado">
		<div class="divisoria-2"><h3 class="titulo-h3">Carrito</h3><div class="linea-divisoria-4"></div></div>
		...
		if (count($carrito[0]) > 0){
			...
			for ($j = 0; $j < $longitud; $j++){
				...
				printf('<div class="carrito-producto">');
				printf('<a class="carrito-producto-img text-white" href="'.base_url() . "User/paginaProducto/".$nombreProducto.'"><img src="'.$carrito[$j][0]["foto"].'"height="127" width="90"/></a>');
				printf('<div class="carrito-producto-nombre"><h6><a class="text-white" href="'.base_url() . "User/paginaProducto/".$nombreProducto.'">'.$carrito[$j][0]["nombre"].'</a></h6></div>');
				printf('<div class="carrito-divisoria"><div class="divisoria-2"><div class="linea-divisoria-2"></div></div></div>');
				printf('<div class="carrito-producto-precio">');
				printf('<br>'.$carrito[$j][0]["precio"].'€');
				printf('<a href="'.base_url() . "User/borrarDelCarrito/".$nombreProducto.'"><button type="button" class="btn-carrito ml-3"><i class="fas fa-fw fa-times"></i></button></a></div></div>');
			...
			echo '</div>';
			echo '<div class="carrito-precio-total-pagar">';
			printf('<a href="'.base_url() . "User/pagar/".'"><button type="button" class="btn-carrito-pagar">Pagar&nbsp;&nbsp;<i class="fas fa-fw fa-shopping-cart"></i></button></a>');
			echo '</div>';
			echo '</div>';
			echo '</div>';
			//-------------
			...
			echo 'Aun no has añadido ningun producto a tu carrito, haz click en el carrito de un producto para añadirlo';
			echo '</div>';
		}
		?>
