...
<head>
	<meta charset="UTF-8">
	<title>Mostrar Ganancias -  DigitalKey</title>
...
<div class="cuerpo mt-5 white">
	<div class="mod container text-center mt-5">
		<div class="d-sm-flex align-items-center justify-content-center mb-4">
			<h1 class="h2 mb-0 text-gray-800">Mostrar Productos</h1>
		</div>

		<div class="espacidado"></div>

		<div class="d-sm-flex align-items-center justify-content-center mb-4">
			<h4 class="mb-0 text-gray-700">Vendedor: <?php echo $this->cifrado->superdescifrar($this->session->userdata('nombre')); ?></h4>
		</div>

		<div class="d-sm-flex align-items-center justify-content-center mb-4">
			<h4 class="mb-0 text-gray-700">Ganancias Totales: <?php echo $ganancias.'€';?></h4>
		</div>
		...
		if ($producto > 0){
			...
			echo "<TR>";
			printf("<TD>Id</TD><TD>Nombre</TD><TD>Precio</TD><TD>Foto</TD>");
			print "</TR class='text-center'>";

			for ($j = 0; $j < $longitud; $j++){
				printf('<TD>'.$producto[$j][0]["id"].'</TD><TD>'.$producto[$j][0]["nombre"].'<TD>'. $producto[$j][0]["precio"].'</TD><TD><img src="'.$producto[$j][0]["foto"].'" border="0" class="img-fluid" style="width: 2.5rem;"></TD>');
				print "</TR>";
			}
			echo '</table>';
		}else{
			echo '<div class="container-fluid espacidado">';
			echo 'Aun no se ha realizado ninguna compra';
			echo '</div>';
		}
		?>
	</div>
