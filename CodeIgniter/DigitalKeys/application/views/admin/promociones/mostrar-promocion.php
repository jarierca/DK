...
<head>
	<meta charset="UTF-8">
	<title>Mostrar Promociones -  DigitalKey</title>
...
<div class="cuerpo mt-5 white">
	<div class="mod container text-center mt-5">
		<div class="d-sm-flex align-items-center justify-content-center mb-4">
			<h1 class="h3 mb-0 text-gray-800">Mostrar Promociones</h1>
		</div>
		...
		echo "<TR>";
		printf("<TD>Id</TD><TD>Nombre Promo</TD><TD>Foto</TD>");
		print "</TR>";

		for ($j = 0; $j < $longitud; $j++){
			printf('<TD>'.$producto[$j]["id"].'</TD><TD>'.$producto[$j]["nombre"].'</TD><TD><img src="'.$producto[$j]["foto"].'" border="0" class="img-fluid" style="width: 20rem;"></TD>');
			print "</TR>";
		}
		echo '</table>';
		?>
