...
<head>
	...
	<meta name="description" content="digitalkeys.com - Modificar Contraseña Perdida">
	<meta name="keywords" content="digitalkeys, restablecer contraseña perdida, modificar contraseña">
	...
	<script type="text/javascript">
		function validarModificacion(){
			...
			valor = document.getElementById("newPass").value;
			if(valor.length == 0){
				alert("Falta la contraseña");
				return false;
			}

			valor = document.getElementById("newRepeatPassword").value;
			if(valor.length == 0){
			...
			repeatPass = document.getElementById("newRepeatPassword").value;
			if(pass != repeatPass){
...
<div class="cuerpo mt-5">
	<div class="container text-center mt-5">
		...
		<div class="mt-5 mb-5">
			<h1 class="h3 mb-0 text-gray-800">Nueva Contraseña</h1>
		</div>

		<div class="mod container-fluid">
			<form name="formularioModificar"class="user" method="post" action="<?php echo base_url() . "User/cambiarPassOlvidada"; ?>" onsubmit="return validarModificacion()">
				<div class="form-group">
					Escribe una nueva contraseña
					<input type="Password" class="form-control-2 form-control-user mt-2" id="newPass" name="newPass" placeholder="Escribe una nueva contraseña">
				</div>

				<div class="form-group">
					Repite la contraseña
					<input type="Password" class="form-control-2 form-control-user mt-2" id="newRepeatPassword" name="newRepeatPassword" placeholder="Repite la contraseña">
				</div>
				...
				<div class="d-sm-flex align-items-center justify-content-center mt-5 mb-4">
					<a  class="btn-carrito verde-perfil btn-icon-split btn-sm">
						<span class="text">
						 	<input type="submit" class="btn btn-user" id="enviar" name="enviar" value="Cambiar Contraseña">
						</span>
					</a>
				</div>
			</form>
