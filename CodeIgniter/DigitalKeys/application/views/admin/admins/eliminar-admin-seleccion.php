...
<head>
	<meta charset="UTF-8">
	<title>Eliminar Admins -  DigitalKey</title>
	...
	<script type="text/javascript">
		function validarModificacion(){
			...
			valor = document.getElementById("adminBorrar").value;
			if(valor.length == "0"){
...
<div class="cuerpo mt-5">
	<div class="mod container text-center mt-5">
		<form name="formularioAñadir"class="user" method="post" action="<?php echo base_url() . "Admin/eliminarAdmin"; ?>" onsubmit="return validarModificacion()" enctype="multipart/form-data" >
			<div class="d-sm-flex align-items-center justify-content-center mb-4">
				<h1 class="h3 mb-0 text-gray-800">Eliminar Admin</h1>
			</div>

			<select class="form-control-2" id="adminBorrar" name="adminBorrar" >
				<option value="">Selecciona un admin para borrar sus datos</option>
				<?php
