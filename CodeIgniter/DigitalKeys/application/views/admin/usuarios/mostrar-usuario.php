...
<head>
	<meta charset="UTF-8">
	<title>Mostrar Usuario -  DigitalKey</title>
...
<div class="cuerpo mt-5 white">
	<div class="mod container text-center mt-5">
		<div class="d-sm-flex align-items-center justify-content-center mb-4">
			<h1 class="h3 mb-0 text-gray-800">Mostrar Usuarios</h1>
		</div>
		...
		for ($j = 0; $j < $longitud; $j++){
			printf('<TD>'.$users[$j]["id"].'</TD><TD>'.$this->cifrado->superdescifrar($users[$j]["nick"]).'</TD><TD>'.$this->cifrado->superdescifrar($users[$j]["nombre"]).'</TD><TD>'.$this->cifrado->superdescifrar($users[$j]["apellido1"]).'</TD><TD>'.$this->cifrado->superdescifrar($users[$j]["apellido2"]).'</TD><TD>'. $this->cifrado->superdescifrar($users[$j]["telefono"]).'</TD><TD>'. $this->cifrado->superdescifrar($users[$j]["mail"]).' </TD>');
			print "</TR>";
		}
		echo '</table>';
		?>
