...
<head>
	<meta charset="UTF-8">
	<title>Soporte Admin -  DigitalKey</title>
...
<div class="cuerpo mt-5 white">
	<div class="mod container text-center mt-5">
		<div class="d-sm-flex align-items-center justify-content-center mb-4">
			<h1 class="h3 mb-0 text-gray-800">Soporte Admin</h1>
		</div>

		<div class="row well mb-5 espacidado">
			<div class="col-sm lead">
				<h2>Centro de soporte de DigitalKeys</h2>
			</div>
		</div>
				...
				<div class="tablas-soporte-opciones">
					<div class="panel panel-info">
						...
						<div class="panel-body text-center">
							...
							<a type="button" class="btn btn-info btn-soporte-abajo" href="<?php echo base_url() . "Admin/crearTicket"; ?>">Nuevo Ticket</a>
						</div>
					</div>
				</div>
			</div>
			...
			<div class="col-sm-6">
				<div class="tablas-soporte-opciones">
					<div class="panel panel-danger">
						...
						<div class="panel-body text-center">
							<h4>Colsultar y resolver tickets</h4>
							...
							<a type="button" class="btn btn-success btn-soporte-abajo" href="<?php echo base_url() . "Admin/consultarTickets"; ?>">Consultar Tickets</a>
						</div>
					</div>
				</div>
			</div>
