<?php 
    ...
    $correo->Subject = "Bienvenido a DigitalKeys";//asunto
    //Se pone el texo del mensaje
    $correo->MsgHTML("¡Hola! ".$nombre." ".$apellido1." ".$apellido2.".<br>Gracias por registrarse en DigitalKeys, la mejor pagina para comparar juegos y herramientas de forma digital con un precio reducido y un servicio rapido.");//mensaje o cupor del correo
