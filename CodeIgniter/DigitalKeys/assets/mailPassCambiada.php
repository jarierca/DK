<?php
	...
	$correo->Subject = "Modificacion de Digital Keys";//asunto
	//Se pone el texo del mensaje
	$correo->MsgHTML("Hola ".$nombre." ".$apellido2." ".$apellido2.".<br>Usted ha modificado su contraseña de Digital Keys.");//mensaje o cupor del correo
