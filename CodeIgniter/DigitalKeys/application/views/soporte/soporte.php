...
<head>
	...
	<meta name="description" content="digitalkeys.com - Centro de Soporte">
	<meta name="keywords" content="digitalkeys, centro de soporte, ayuda, soporte, ticket, tickets">
...
<div class="cuerpo">
	<div class="container espacidado">
		...
		<div class="row">
			<div class="col-sm-6">
				<div class="tablas-soporte-opciones">
					<div class="panel panel-info">
						<div class="panel-heading text-center subtabla-soporte-opciones"><i class="fa fa-file-text"></i>&nbsp;<strong>Nuevo Ticket</strong></div>
						<div class="panel-body text-center">
							<h4>Abrir un nuevo ticket</h4>
							<p >Si tienes un problema con cualquiera de nuestros productos reportalo creando un nuevo ticket y te ayudaremos a solucionarlo.</p>
							<p>Para abrir un nuevo <strong>ticket</strong> has click en el siguiente boton</p>
							<a type="button" class="btn btn-info btn-soporte-abajo" href="<?php echo base_url() . "User/crearTicket"; ?>">Nuevo Ticket</a>
						</div>
					</div>
				</div>
			</div>
			...
			<div class="col-sm-6">
				<div class="tablas-soporte-opciones">
					<div class="panel panel-danger">
						<div class="panel-heading text-center subtabla-soporte-opciones"><i class="fa fa-link"></i>&nbsp;<strong>Comprobar estado de Tickets</strong></div>
						<div class="panel-body text-center">
							<h4>Colsultar tus tickets</h4>
							<p>Consulta el estado de tus tickets abiertos, finalizados o pendientes, tambien puedes modificarlo si aun no se ha resuelto.</p>
							<p>Para ver todos tus <strong>tickets</strong> has click en el siguiente boton</p>
							<a type="button" class="btn btn-success btn-soporte-abajo" href="<?php echo base_url() . "User/consultarTickets"; ?>">Consultar Tickets</a>
						</div>
					</div>
				</div>
			</div>
