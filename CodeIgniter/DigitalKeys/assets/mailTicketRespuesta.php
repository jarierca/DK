<?php 
    ...
    $correo->Subject = "Actualizacion de Estado del Ticket - Soporte";//asunto
    //Se pone el texo del mensaje
    $correo->MsgHTML("¡Hola! ".$nick.".<br>Hemos tramitado tu ticket y actualizado su estado y solucion, para ver el resultado consultalo en el apartado de Soporte >> Consultar Tickets.<br> Ahi pordras ver toda la informacion del Ticket.");//mensaje o cupor del correo
