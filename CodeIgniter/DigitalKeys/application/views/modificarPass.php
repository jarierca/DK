...
<head>
	<meta charset="UTF-8">
	<title>Modificar Contraseña -  DigitalKey</title>
	<meta name="viewport" content="width=device-width, initial-scale=1.0, maximum-scale=1.0, user-scalable=0">
	<meta name="description" content="digitalkeys.com - Modificar Contraseña">
	<meta name="keywords" content="digitalkeys, editar contraseña, perfil">
	...
	<script type="text/javascript">
		function validarModificacion(){
			...
			valor = document.getElementById("passOld").value;
			if(valor.length == 0){
				alert("Falta la antigua contraseña");
				return false;
			}

			valor = document.getElementById("passMod").value;
			if(valor.length == 0){
				alert("Falta la contraseña");
				return false;
			}

			valor = document.getElementById("RepeatPasswordMod").value;
			if(valor.length == 0){
				alert("Falta repetir la contraseña");
				return false;
			}

			pass = document.getElementById("passMod").value;
			repeatPass = document.getElementById("RepeatPasswordMod").value;
			if(pass != repeatPass){
...
<div class="cuerpo mt-5">
	<div class="container text-center mt-5">
		...
		<div class="mt-5 mb-5">
			<h1 class="h3 mb-0 text-gray-800">Modificar Contraseña</h1>
		</div>

		<div class="mod container-fluid">
			<form name="formularioModificar"class="user" method="post" action="<?php echo base_url() . "User/modificarPass"; ?>" onsubmit="return validarModificacion()">
				<div class="form-group">
					Escribe tu antigua contraseña
					<input type="Password" class="form-control-2 form-control-user mt-2" id="passOld" name="passOld" placeholder="Escribe tu antigua contraseña">
				</div>

				<div class="form-group">
					Escribe una nueva contraseña
					<input type="Password" class="form-control-2 form-control-user mt-2" id="passMod" name="passMod" placeholder="Escribe una nueva contraseña">
				</div>

				<div class="form-group">
					Repite la contraseña
					<input type="Password" class="form-control-2 form-control-user mt-2" id="RepeatPasswordMod" name="RepeatPasswordMod" placeholder="Repite la contraseña">
				</div>
