...
<head>
	<meta charset="UTF-8">
	<title>Modificar Vendedor -  DigitalKey</title>
...
<div class="cuerpo mt-5">
	<div class="mod container text-center mt-5">
		<form name="modPiso" class="user" method="post" action="<?php echo base_url() . "Admin/modificarVendedor"; ?>" onsubmit="return validarModificacion()" enctype="multipart/form-data">
			<div class="d-sm-flex align-items-center justify-content-between mb-4">
				<h1 class="h3 mb-0 text-gray-800">Modificar Vendedor</h1>
			</div>

			<?php
			$longitud = count($vendedorSel);
			for ($j = 0; $j < $longitud; $j++){
				?>
				<input type="text" id="idMod" name="idMod" value="<?php echo $vendedorSel[$j]["id"];?>" hidden>
				<div class="form-group">
					Nombre
					<input type="text" class="form-control-2 form-control-user" id="nombreMod" name="nombreMod" placeholder="Introduce el nombre" value="<?php echo $this->cifrado->superdescifrar($vendedorSel[$j]["nombre"]);?>">
				</div>
				...
				<div class="form-group">
					Email
					<input type="email" class="form-control-2 form-control-user" id="mailMod" name="mailMod" placeholder="Introduce un email" value="<?php echo $this->cifrado->superdescifrar($vendedorSel[$j]["mail"]);?>">
				</div>
				<div class="form-group">
					Telefono
					<input type="text" class="form-control-2 form-control-user" id="telefonoMod" name="telefonoMod" placeholder="Introduce el telefono" value="<?php echo $this->cifrado->superdescifrar($vendedorSel[$j]["telefono"]);?>">
				</div>
