        ...
        <div class="container espacidado">
            <div class="temas-legales">
				...
				<div class="espacidado">
					<h4 class="espacidado" style="text-shadow: 0 0 9px rgba(255,255,255,.7);">¿Los códigos de los CDs son oficiales?<br>
					</h4>
					...
					<h4 class="espacidado" style="text-shadow: 0 0 9px rgba(255,255,255,.7);">¿Cómo puedo descargar un juego? ¿Esto es legal?</h4>
					<p>La descarga de juegos es perfectamente legal a través de las plataformas oficiales de EA Origin, Steam, Battle.net, NCSoft o Ubisoft.<br>
							<br>
							Sólo tienes que descargarlos a través de su software disponible en sus páginas web oficiales, ya que todos ellos ofrecen ahora descargas legales de juegos.</p>
					<h4 class="espacidado" style="text-shadow: 0 0 9px rgba(255,255,255,.7);">¿Cómo puedo activar una clave de CD?</h4>
					<p>Para activar tu juego simplemente ves a la ficha de dicho juego y haz clic en "Activar este juego en..." para ver una guía del proceso para la plataforma en cuestión.</p></div>
					<h4 class="espacidado" style="text-shadow: 0 0 9px rgba(255,255,255,.7);">¿Tengo que crear una cuenta para comprar un código de CD?</h4>
					<p>Sí, por varias razones: principalmente para obtener tu clave de CD directamente en la sección "Mis pedidos", pero también para poder ponerte en contacto con nosotros a través del sistema de tickets, que requiere una identificación.<br>
							<br>
							Para crear una cuenta o iniciar sesión, utiliza el panel a la izquierda de la página principal de nuestra web: https://www.instant-gaming.com/<br>
						</p>
					<h4 class="espacidado" style="text-shadow: 0 0 9px rgba(255,255,255,.7);">No me puedo conectar (contraseña perdida).</h4>
					<p>Si no puedes iniciar sesión, puedes recuperar tu contraseña en esta dirección: https://www.instant-gaming.com/es/contrasenas-olvidadas/ Será necesario su correo electrónico.<br>
							<br>
							Para cualquier otro problema de conexión, usa la sección "Contacto" .</p>
					<h4 class="espacidado" style="text-shadow: 0 0 9px rgba(255,255,255,.7);">¿Cuánto tiempo tardaré en recibir mi código de CD?</h4>
					<p>La recepción del código es inmediata, sólo tienes que ir a la sección "Mi cuenta" para ver tu última clave de CD comprada. También podrás ver todo el historial de tus compras desde la creación de la cuenta.</p>
					<h4 class="espacidado" style="text-shadow: 0 0 9px rgba(255,255,255,.7);">La clave de CD que he recibido no funciona.</h4>
					<p>Si la clave de CD recibida no funciona o si el código es difícil de leer, abre un ticket en la sección "Contacto" para que podamos encontrar el origen del problema.</p>
					<h4 class="espacidado" style="text-shadow: 0 0 9px rgba(255,255,255,.7);">¿Hay una fecha límite para utilizar mi clave de CD?</h4>
					<p>¡No! No hay límite de tiempo, así que puedes utilizarlo cuando lo desees, o lo puedes usar para hacer un buen regalo.</p>
					<h4 class="espacidado" style="text-shadow: 0 0 9px rgba(255,255,255,.7);">¿Las claves son válidas en todos los países?</h4>
					<p>No, los editores están sometidos a una política de regulación de importación/exportación de los juegos. Los códigos a veces son objeto de una restricción nacional, pero no siempre es el caso. Puedes ver esta información en la página de cada juego antes de comprarlo.</p>
					<h4 class="espacidado" style="text-shadow: 0 0 9px rgba(255,255,255,.7);">¿Es posible un reembolso?</h4>
					<p>Teniendo en cuenta la naturaleza de las claves de CD que vendemos, es posible hacer un reembolso, pero puede que necesitemos un plazo de 10 días para comprobar que el código no haya sido utilizado.</p>
					<h4 class="espacidado" style="text-shadow: 0 0 9px rgba(255,255,255,.7);">¿Cuántas veces puedo descargar un juego?</h4>
					<p>Una vez que la clave de CD esté activada en tu cuenta, puedes volver a descargarlo tantas veces como desees (salvo si se indica lo contrario en la plataforma de descarga). Asegúrate de conectarte con la misma cuenta utilizada para validar la clave de CD.</p>

					<h2 class="espacidado">¿Cómo funciona?</h2>
					<h5>1 ¿Por qué son tan bajos nuestros precios?</h5>
					<p class="ig-about-p">Instant Gaming es sobre todo un grupo de jugadores apasionados, de los que hacían las largas colas de las grandes tiendas para gastarse sus ahorros y comprarse el último juego que hubiese salido al mercado.<br><br>Como gamers, nuestra prioridad es ofrecerte un acceso inmediato a los mejores juegos y, sobre todo, a los mejores precios. Gracias a los juegos en formato electrónico, recortamos considerablemente los gastos de almacenaje físico y de logística. Además, adquirimos los juegos en grandes cantidades. Todo esto nos permite ofrecer estos precios.</p>
					<h5>2 ¿Cómo funciona? ¡Juega sin tener que desplazarte!</h5>
					<div style="padding: 25px">
						<h6>2.1 Plataformas oficiales</h6>
						<p>Obtén el código en unos segundos y válida la clave del CD oficial comprado en nuestra web:</p>
						<img style="padding: 25px" src="https://s3.gaming-cdn.com/themes/igv1/modules/faq/images/ig-about-platform.png">
						<h6>2.2 Rápido</h6>

						<p>Descarga tus juegos legalmente a través de plataformas como Steam, Origin, Uplay ...</p>
