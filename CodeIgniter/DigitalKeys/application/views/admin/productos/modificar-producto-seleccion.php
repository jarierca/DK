...
<div class="cuerpo mt-5">
	<div class="mod container text-center mt-5">
		<form name="formularioAñadir"class="user" method="post" action="<?php echo base_url() . "Admin/modificarProductoVistaDatos"; ?>" onsubmit="return validarModificacion()" enctype="multipart/form-data" >
			<div class="d-sm-flex align-items-center justify-content-center mb-4">
				<h1 class="h3 mb-0 text-gray-800">Modificar Producto</h1>
			</div>

			<select class="form-control-2" id="productoMod" name="productoMod" >
				<option value="">Selecciona el producto para modificar sus datos</option>
				<?php
