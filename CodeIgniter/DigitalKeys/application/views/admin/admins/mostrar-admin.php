...
<head>
	<meta charset="UTF-8">
	<title>Mostrar Admins -  DigitalKey</title>
...
<div class="cuerpo mt-5 white">
	<div class="mod container text-center mt-5">
		<div class="d-sm-flex align-items-center justify-content-center mb-4">
			<h1 class="h3 mb-0 text-gray-800">Mostrar Admins</h1>
		</div>
		...
		echo "<TR>";
		printf("<TD>Id</TD><TD>Nick</TD><TD>Nombre</TD><TD>Apellido 1</TD><TD>Apellido 2</TD><TD>Telefono</TD><TD>Email</TD>");
		print "</TR>";

		for ($j = 0; $j < $longitud; $j++){
			printf('<TD>'.$admin[$j]["id"].'</TD><TD>'.$this->cifrado->superdescifrar($admin[$j]["nick"]).'</TD><TD>'.$this->cifrado->superdescifrar($admin[$j]["nombre"]).'</TD><TD>'.$this->cifrado->superdescifrar($admin[$j]["apellido1"]).'</TD><TD>'.$this->cifrado->superdescifrar($admin[$j]["apellido2"]).'</TD><TD>'. $this->cifrado->superdescifrar($admin[$j]["telefono"]).'</TD><TD>'. $this->cifrado->superdescifrar($admin[$j]["mail"]).' </TD>');
			print "</TR>";
		}
		echo '</table>';
		?>
