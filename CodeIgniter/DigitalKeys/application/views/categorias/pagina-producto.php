...
<head>
    <meta charset="UTF-8">
    <title><?php echo $pagiPC[0]['nombre']; ?> -  DigitalKey</title>
	<meta name="viewport" content="width=device-width, initial-scale=1.0, maximum-scale=1.0, user-scalable=0">
	<meta name="description" content="digitalkeys.com - <?php echo $pagiPC[0]['nombre']; ?>">
	<meta name="keywords" content="digitalkeys, gaming, <?php echo $pagiPC[0]['nombre'].$pagiPC[0]['genero'].", ".$pagiPC[0]['plataforma'].", ".$pagiPC[0]['plataformaPublicacion'];?>">
...
<div class="cuerpo">
    <div class="container espacidado">
        <div class="divisoria-2"><h3 class="titulo-producto-pagina"><?php $nombreProducto = str_replace(" ","-",$pagiPC[0]['nombre']);
				echo $pagiPC[0]['nombre'];
				?></h3><div class="linea-divisoria-4"></div></div>

		<div class="pagina-producto">
			<div class="container espacidado">
				<div class="producto-grande flex pt-5">
					<?php echo '<img clas="" src="'.$pagiPC[0]['foto'].'" height="408" width="288"/>'; ?>

					<div class="text-white px-5">
						<h3><?php echo $pagiPC[0]['nombre']; ?></h3>

						<div class="precio-producto pl-3">
							Precio: <?php echo $pagiPC[0]['precio']; ?>€

							<?php
							if ($stock){
								echo '<a href="'.base_url() . "User/anadirAlCarrito/".$nombreProducto.'"><button type="button" class="btn-carrito">Comprar <i class="fas fa-fw fa-shopping-cart"></i></button></a>';
							}else{
								echo '<a><button type="button" class="btn-carrito">Agotado<i class="fas fa-times"></i></button></a>';
							}
							?>
							<a href="<?php echo base_url() . "User/anadirAWhitelist/".$nombreProducto; ?>"><button type="button" class="btn-whitelist">Favoritos <i class="fas fa-heart"></i></button></a>
						</div>
						<div class="pl-3 mt-2 pt-2"> Genero: <?php echo $pagiPC[0]['genero']; ?> / Plataforma: <?php echo $pagiPC[0]['plataforma']; ?> - <?php echo $pagiPC[0]['plataformaPublicacion']; ?> </div>
						<div class="pl-3 mt-2 pt-2 vendedor-producto">Fecha de lanzamiento: <?php echo $pagiPC[0]['fecha']; ?></div>
						<div class="divisoria-2 espacidado"><div class="linea-divisoria-2"></div></div>

						<div class="px-1">
							<div class="descripcion-pagina-producto px-2 pt-2">
								<?php echo $pagiPC[0]['descripcion']; ?>
							</div>
						</div>
					</div>
				...
				<div class="producto-pequeño flex pt-5">
					<div class="text-white px-5 text-center">

						<?php echo '<img clas="" src="'.$pagiPC[0]['foto'].'" height="408" width="288"/>'; ?>
						<h5><?php echo $pagiPC[0]['nombre'];?></h5>
						<div class="pl-3 mt-2 pt-2 vendedor-producto">Fecha de lanzamiento: <?php echo $pagiPC[0]['fecha']; ?></div>
						...
						<div class="precio-producto">
							Genero: <?php echo $pagiPC[0]['genero']; ?>
						</div>
						<div class="precio-producto">
							<?php
							if ($stock){
