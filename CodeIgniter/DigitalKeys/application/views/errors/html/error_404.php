...
<head>
	<meta charset="UTF-8">
	<title>404 Page Not Found -  DigitalKey</title>
	<meta name="viewport" content="width=device-width, initial-scale=1.0, maximum-scale=1.0, user-scalable=0">
	<meta name="description" content="digitalkeys.com - Error 404">
	<meta name="keywords" content="digitalkeys, error">
			...
			<div class=" row mx-auto">
				...
				<div class="navbar-nav barra-botones">
					...
					<li class="nav-item dropdown no-arrow mx-1">
						<a class="nav-link" href="<?php echo base_url() . "inicio";?>" id="alertsDropdown" role="button">
...
<div class="cuerpo">
	<div class="container">
		<p class="display-3">ERROR 404 PAGINA NO ENCONTRADA.</p>
	</div>
</div>
</div>
<footer class="foot">
