...
<head>
	<meta charset="UTF-8">
	<title>Modificar Admin -  DigitalKey</title>
...
<div class="cuerpo mt-5">
	<div class="mod container text-center mt-5">
		<form name="modPiso" class="user" method="post" action="<?php echo base_url() . "Admin/modificarAdmin"; ?>" onsubmit="return validarModificacion()" enctype="multipart/form-data">
			<div class="d-sm-flex align-items-center justify-content-between mb-4">
				<h1 class="h3 mb-0 text-gray-800">Modificar Admin</h1>
			</div>

			<?php
			$longitud = count($adminSel);
			for ($j = 0; $j < $longitud; $j++){
				?>
				<input type="text" id="idMod" name="idMod" value="<?php echo $adminSel[$j]["id"];?>" hidden>
				<div class="form-group">
					Nick
					<input type="text" class="form-control-2 form-control-user" id="nickMod" name="nickMod" placeholder="Introduce un nick" value="<?php echo $this->cifrado->superdescifrar($adminSel[$j]["nick"]);?>">
				</div>
				...
				<div class="form-group">
					Nombre
					<input type="text" class="form-control-2 form-control-user" id="nombreMod" name="nombreMod" placeholder="Introduce el nombre" value="<?php echo $this->cifrado->superdescifrar($adminSel[$j]["nombre"]);?>">
				</div>
				<div class="form-group">
					Primer Apellido
					<input type="text" class="form-control-2 form-control-user" id="apellido1Mod" name="apellido1Mod" placeholder="Introduce el primer apellido" value="<?php echo $this->cifrado->superdescifrar($adminSel[$j]["apellido2"]);?>">
				</div>

				<div class="form-group">
					Segundo Apellido
					<input type="text" class="form-control-2 form-control-user" id="apellido2Mod" name="apellido2Mod" placeholder="Introduce el segundo apellido" value="<?php echo $this->cifrado->superdescifrar($adminSel[$j]["apellido2"]);?>">
				</div>

				<div class="form-group">
					Telefono
					<input type="text" class="form-control-2 form-control-user" id="telefonoMod" name="telefonoMod" placeholder="Introduce el telefono" value="<?php echo $this->cifrado->superdescifrar($adminSel[$j]["telefono"]);?>">
				</div>

				<div class="form-group">
					Email
					<input type="text" class="form-control-2 form-control-user" id="mailMod" name="mailMod" placeholder="Introduce el telefono" value="<?php echo $this->cifrado->superdescifrar($adminSel[$j]["mail"]);?>">
				</div>
				<div class="d-sm-flex align-items-center justify-content-center mt-5 mb-4">
					...
					<span class="text">
						<input type="submit" class="btn btn-user" id="enviar" name="enviar" value="Modificar Admin">
					</span>
					</a>
				</div>
			<?php }?>
