...
<head>
    ...
    <script type="text/javascript">
        function validarLogin(){
            ...
            valor = document.getElementById("NickAdmin").value;
            if(valor.length == 0){
                alert("Falta el nick");
                return false;
            }

            valor = document.getElementById("PasswordAdmin").value;
            if(valor.length == 0){
...
<body>
    <div class="cuerpo espacidado">
        <div class="text-center">
            <h1 class="h4 text-gray-900 mb-4">Bienvenido al Panel de Administrador</h1>
        ...
        <div class="login espacidado">
            <form name="formularioLogin" class="user" method="post" action="<?php echo base_url() . "Admin/logearseAdmin"; ?>" onsubmit="return validarLogin()">
                <div class="form-group">
                    <input type="text" class="form-control-2 form-control-user" id="NickAdmin" name="NickAdmin" placeholder="Introduce tu nick">
                </div>
                <div class="form-group">
                    <input type="password" class="form-control-2 form-control-user" id="PasswordAdmin" name="PasswordAdmin" placeholder="Contraseña">
                </div>
        ...
        <div class="container">
            <div class="footer-main-content">
				...
				<div class="footer-main-2">
					...
					<div class="footer-items">
						<a href="<?php echo base_url() . "Admin/miCuenta"; ?>">MI CUENTA</a><br>
						<br>
						<br>
					</div>
				</div>
