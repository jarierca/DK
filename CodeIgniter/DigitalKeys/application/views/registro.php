...
<head>
    <meta charset="UTF-8">
    <title>Registro -  DigitalKey</title>
	<meta name="viewport" content="width=device-width, initial-scale=1.0, maximum-scale=1.0, user-scalable=0">
	<meta name="description" content="digitalkeys.com - Crear Una Cuenta">
	<meta name="keywords" content="digitalkeys, registrarse, crear una cuenta">
    ...
    <script type="text/javascript">
        function validacion(){
            ...
            if(valor.length == 0){
                alert("Falta el nick");
                return false;
            }else if(noValido.test(valor)){ // se chequea el regex de que el string no tenga espacio
                alert ("El nick no puede contener espacios en blanco");
                return false;
            }
            ...
            valor = document.getElementById("InputEmail").value;
            if(valor.length == 0){
            ...
            valor = document.getElementById("InputPassword").value;
            if(valor.length == 0){
            ...
            valor = document.getElementById("RepeatPassword").value;
            if(valor.length == 0){
            ...
            if(valor.length == 0){
                ...
                alert ("La edad no puede contener espacios en blanco");
                return false;
            }
            ...
            if(pass != repeatPass){
                ...
                if(pass.length < 8){
                    alert("La contraseña es demasidado corta");
                    return false;
                }
            }
            return true;
...
<body>
    <div class="cuerpo espacidado">
        ...
        <div class="registro espacidado">
            <form name="formularioRegistro"class="user" method="post" action="<?php echo base_url() . "User/registrar"; ?>" onsubmit="return validacion()">
                <div class="form-group">
                    <input type="text" class="form-control-2 form-control-user" id="Nick" name="Nick" placeholder="Nick o Alias">
                </div>
                <div class="form-group">
					<input type="text" class="form-control-2 form-control-user" id="FirstName" name="FirstName" placeholder="Nombre">
				</div>
				<div class="form-group row">
                    <div class="col-sm-6">
                        <input type="text" class="form-control-2 form-control-user" id="LastName" name="LastName" placeholder="Primer Apellido">
                    </div>
					<div class="col-sm-6">
						<input type="text" class="form-control-2 form-control-user" id="LastName" name="LastName2" placeholder="Segundo Apellido">
					</div>
                </div>
                <div class="form-group">
                    <input type="email" class="form-control-2 form-control-user" id="InputEmail" name="InputEmail" placeholder="Correo Electronico">
                </div>
                <div class="form-group row">
                    <div class="col-sm-6 mb-3 mb-sm-0">
                        <input type="password" class="form-control-2 form-control-user" id="InputPassword" name="InputPassword" placeholder="Contraseña">
                    </div>
                    <div class="col-sm-6">
                        <input type="password" class="form-control-2 form-control-user" id="RepeatPassword" name="RepeatPassword" placeholder="Repite la Contraseña">
                    </div>
                </div>
                <div class="form-group">
					<input type="text" class="form-control-2 form-control-user" id="Telefono" name="Telefono" placeholder="Teléfono">
                </div>

                <input type="submit" class="btn btn-primary-2 btn-user btn-block" id="enviar" name="enviar" value="Registrar Cuenta">
