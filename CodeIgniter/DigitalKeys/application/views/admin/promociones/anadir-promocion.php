...
<head>
	<meta charset="UTF-8">
	<title>Añadir Promoción -  DigitalKey</title>
	...
	<script type="text/javascript">
		function validarModificacion(){
			...
			valor = document.getElementById("promocion").value;
			if(valor.length == 0){
				alert("Falta el nombre de la promocion");
				return false;
			}
			return true;
		}
...
<div class="cuerpo mt-5">
	<div class="mod container text-center mt-5">
		<form name="formularioAñadir"class="user" method="post" action="<?php echo base_url() . "Admin/anadirPromociones"; ?>" onsubmit="return validarModificacion()" enctype="multipart/form-data" >
			<div class="d-sm-flex align-items-center justify-content-center mb-4">
				<h1 class="h3 mb-0 text-gray-800">Añadir Promoción</h1>
			</div>
			...
			<div class="form-group">
				<input type="text" class="form-control-2 form-control-user" id="promocion" name="promocion" placeholder="Nombre Promocion">
			</div>
			...
			<div class="form-group">
				<input type="text" class="form-control-2 form-control-user" id="where_sql_veces" name="where_sql_veces" placeholder="where sql veces">
			</div>

			<div class="form-group">
				<input type="text" class="form-control-2 form-control-user" id="where_campo" name="where_campo" placeholder="where_campo (campo1/campo2)">
			</div>

			<div class="form-group">
				<input type="text" class="form-control-2 form-control-user" id="where_condicion" name="where_condicion" placeholder="where_condicion (condicion1/condicion2)">
			</div>
			...
			<div class="form-group">
				<input type="text" class="form-control-2 form-control-user" id="like_sql_veces" name="like_sql_veces" placeholder="like_sql_veces">
			</div>

			<div class="form-group">
				<input type="text" class="form-control-2 form-control-user" id="like_campo" name="like_campo" placeholder="like_campo (campo1/campo2)">
			</div>

			<div class="form-group">
				<input type="text" class="form-control-2 form-control-user" id="like_condicion" name="like_condicion" placeholder="like_condicion (condicion1/condicion2)">
			</div>

			<div class="form-group">
				<input type="text" class="form-control-2 form-control-user" id="like_match" name="like_match" placeholder="like_match (before, after, none, both) (match1/match2)">
			</div>
			...
			<div class="form-group">
				<input type="text" class="form-control-2 form-control-user" id="orderby_campo" name="orderby_campo" placeholder="orderby_campo (campo1/campo2)">
			</div>

			<div class="form-group">
				<input type="text" class="form-control-2 form-control-user" id="orderby_type" name="orderby_type" placeholder="orderby_type (ASC o DESC) (type1/type2)">
			</div>
			...
			<div class="d-sm-flex align-items-center justify-content-center mt-5 mb-4">
				<a class="btn-carrito verde-perfil btn-icon-split btn-sm">
					...
					<span class="text">
						<input type="submit" class="btn btn-user" id="enviar" name="enviar" value="Crear Promoción">
					</span>
				</a>
			</div>
		</form>
